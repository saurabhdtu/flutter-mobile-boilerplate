...
class DashedLine extends StatelessWidget {
  ...
  final double dashedWidth, dashedHeight;
    ...
    switch (axisDirection) {
      case Axis.vertical:
        return Column(children: [
          for (int i = 1; i <= dashedCount!; i++)
            Padding(
                padding: EdgeInsets.only(
                    bottom: i == dashedCount ? 0 : dashedHeight),
                child: SizedBox(
                    width: dashedWidth,
                    height: dashedHeight,
                    child: DecoratedBox(
      ...
      case Axis.horizontal:
        return Row(children: [
          for (int i = 1; i <= dashedCount!; i++)
            Padding(
                padding:
                    EdgeInsets.only(right: i == dashedCount ? 0 : dashedHeight),
                child: SizedBox(
                    width: dashedHeight,
                    height: dashedWidth,
                    child: DecoratedBox(
